 ...
 if (form.Consignment.value == "" )
		 {
			...
			return false;
              ...
              <tbody><tr>
                <td class="TrackTitle" valign="top"><div class="newtext" align="center"><strong> Track Courier <br>
                        </strong></div></td>
              </tr>
              <tr>
            ...
            <form action="track-result.php" method="post" name="form" id="form" >
                  ...
                  <input name="Submit" type="submit" class="button button1" onClick="MM_validateForm('Consignment','','R');return document.MM_returnValue" value="Track now">
            </form>
  ...
  <tbody><tr>
    ...
    <td bgcolor="#FFCC00" width="304">&nbsp;</td>
  </tr>
</tbody></table>
</td>
  </tr>
