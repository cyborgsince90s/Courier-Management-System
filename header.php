...
<table border="0" cellpadding="0" cellspacing="0" width="900">
  <tbody><tr style="height:25px;">
    <td bgcolor="FFCC00" width="4">&nbsp;</td>
    <td bgcolor="#FFCC00" width="240">&nbsp;<b>Admin Menu</b></td>
    <td bgcolor="#FFCC00" width="130"><div align="center"><a href="offices-list.php" class="headtext13">Office Details</a></div></td>
    <td bgcolor="#FFCC00" width="10">|</td>
	
    <td bgcolor="#FFCC00" width="100"><div align="center"><a href="add-office.php" class="headtext13">Add New Office</a></div></td>
    <td bgcolor="#FFCC00" width="10">|</td>
	<td bgcolor="#FFCC00" width="162"><div align="center"><a href="manager-list.php" class="headtext13">Manager Details</a> </div></td>
    <td bgcolor="#FFCC00" width="7">|</td>
    <td bgcolor="#FFCC00" width="125"><div align="center"><a href="add-new-officer.php" class="headtext13">Add New Manager</a></div></td>
  </tr>
</tbody>
</table>
<?php 
...
<table border="0" cellpadding="0" cellspacing="0" width="900">
  <tbody><tr style="height:25px;">
    ...
    <td bgcolor="#99CCFF" width="10"></td>
     <td bgcolor="#99CCFF" width="162"><div align="center"><a href="CitizensCharter.pdf" class="headtext13">Citizen Charter</a> </div></td>
    <td bgcolor="#99CCFF" width="7">|</td>
	<td bgcolor="#99CCFF" width="162"><div align="center"><a href="admin.php" class="headtext13">Home</a> </div></td>
    <td bgcolor="#99CCFF" width="7">|</td>
	 <td bgcolor="#99CCFF" width="140"><div align="center"><a href="index.php" class="headtext13">Admin Panel</a> </div></td>
